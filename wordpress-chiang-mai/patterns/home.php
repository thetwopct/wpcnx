...
/**
 * Title: home
 * Slug: wordpress-chiang-mai/home
 * Categories: hidden
 * Inserter: no
 */
?>
...
<h1 class="wp-block-heading has-text-align-center has-x-large-font-size">Welcome to the <br>Chiang Mai<br>WordPress Community</h1>
<!-- /wp:heading -->
